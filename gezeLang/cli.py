#!/usr/bin/env python3
# translator.py — GezeLang CLI: python translator.py program.amh
"""
Usage:
...
def main():
    parser = argparse.ArgumentParser(
        description='GezeLang — አማርኛ ፕሮግራሚንግ ቅኵንጋ',
    ...
    if args.compare:
        ...
        print(f"{'━'*40}")
        print("GezeLang — ቅኵንጋ ንጽጽር (Language Comparison)")
        print(f"{'━'*40}")
    ...
    if args.stats:
        from gezeLang.stats import print_stats
